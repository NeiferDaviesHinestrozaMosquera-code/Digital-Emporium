// src/app/[lang]/login/LoginFormClient.tsx
'use client'; // <-- ¡Aquí sí va el "use client"!
...
// El componente del formulario de login que usa hooks de cliente
export default function LoginFormClient({ lang }: { lang: Locale }) {
