...
async function getDashboardData(): Promise<DashboardStats> {
  ...
  clientInquiries.forEach(inquiry => {
    try {
      ...
      const monthKey = format(startOfMonth(inquiryDate), 'yyyy-MM-dd'); // Use a consistent key format
  ...
  const inquiriesTimeChartData = Object.values(inquiriesByMonth)
    .sort((a, b) => compareAsc(a.date, b.date)) // Sort by actual date objects
    .map(item => ({
...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [router]); // Added router to dependency array for refresh on navigation
  ...
  const stats = [
    ...
    { title: "New Inquiries", value: newInquiries, icon: MessageSquare, href: "/admin/inquiries?statusFilter=New" }, // Example filter
